//获取ID
var GEBI = function (id) {return typeof id === "string" ? document.getElementById(id) : id};
//获取tagName
var GEBT = function (tagName, oParent) {return (oParent || document).getElementsByTagName(tagName)};
//自动播放对象
...
AutoPlay.prototype = {
	initialize: function (id)
	{
		var oThis = this;
		this.oBox = GEBI(id);
		this.oUl = GEBT("ul", this.oBox)[0];
		this.aImg = GEBT("img", this.oBox);
		this.timer = null;
		this.autoTimer = null;
		this.iNow = 0;
		this.creatBtn();
		this.aBtn = GEBT("li", this.oCount);
		this.toggle();
