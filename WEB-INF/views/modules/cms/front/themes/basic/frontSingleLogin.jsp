...
<table class="ywlogintable" width="396px" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="2"><div class="denglutext">市民卡用户登录</div></td>
  </tr>
  <tr>
    <td colspan="2">
      <div class="">
        <input class="daxiaolog" id="username" placeholder="手机号/用户名" type="text" value="手机号/用户名" 
  ...
  <tr >
    <td class="huise" width="130"> <input type="checkbox" name="checkbox" id="autoLogin" />
        <label for="checkbox"></label>
         自动登录</td>
    <td>
         <a class="huise" href="${ctx }/single/register${urlSuffix}">免费注册</a>  <a class="huise" href="${ctx }/single/forgetPassword${urlSuffix}">忘记密码？</a></td>
  </tr>
</table>
						...
						$.ajax({
							...
							success:function(data){
								if(data.resultCode==0){
									location.href='${ctx}/single/logined${urlSuffix}';
								}else{
