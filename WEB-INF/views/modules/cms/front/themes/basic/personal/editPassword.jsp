...
<script charset="UTF-8" src="${ctxStatic}/jquery-jbox/2.3/jquery.jBox-2.3.src.js"></script>
				...
				$.ajax({
					...
					success:function(data){
						...
						if(data.resultCode==0){
							location.href='${ctx}/single/editPasswordOk${urlSuffix}';
