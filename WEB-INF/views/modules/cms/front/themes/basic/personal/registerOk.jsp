                        ...
                        <div class="main_ch">
                            <div class="content">
                              <div class="bz_a pad_t30">
                                   <ul>
                                      <li class="huibg"><a href="#">1<span>填写注册信息</span></a></li>
                                      <li style=" width:66px;" class="meibg"><a href="#">2<span>注册成功</span></a></li>
                                   </ul>
                                   <div class="clear"></div>
                                </div>
                                <div class="mar_k">
                                  ...
                                  <tbody><tr>
                                   ...
                                   <span id="countdown" style="color: red; font-weight: bold; font-size: 20px;">3</span>
                                        ...
                                        <br><input type="button" name="button" id="button" value="立即前往" class="but_a span6 mar_t15 " onclick="location.href = '${ctx}/single/login${urlSuffix}'">
                                    </td>
                                  </tr>
                                </tbody></table>
