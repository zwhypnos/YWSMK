...
if (timer >= 1) {
    ...
    location.href = "${ctx}/single/personal-hlht${urlSuffix}";
    }
}
</script>
        ...
        <div class="main_ch">
            <div class="content">
              <div class="bz_a pad_t30">
                   <ul>
                      <li class="huibg"><a href="#">1<span>车牌解绑</span></a></li>
                      <li style=" width:66px;" class="meibg"><a href="#">2<span>解绑完成</span></a></li>
                   </ul>
                   <div class="clear"></div>
                </div>
                <div class="mar_k">
                  ...
                  <tbody><tr>
                   ...
                   <span id="countdown" style="color: red; font-weight: bold; font-size: 20px;">3</span>
                            <span style="font-size:20px;font-weight:bold;color:#ADADAD">秒后将跳转</span>
                        <br><input type="button" name="button" id="button" value="立即跳转" class="but_a span6 mar_t15 " onclick="location.href = '${ctx}/single/personal-hlht${urlSuffix}'">
                    </td>
                  </tr>
                </tbody></table>
